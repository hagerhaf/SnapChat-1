  ...
  return (
    <View style={styles.container}>
      <View style={styles.chatToUserToolBar}>
        ...
        <Text style={[styles.chatToUserToolBarTitle, styles.chatText]}>{username}</Text>
        <Text style={[styles.chatToUserToolBarButton, styles.chatText]} onPress={() => onBackPress()}>Back</Text>
      </View>
